...
const fs = require("fs")
const csv = require("fast-csv")              // npm install fast-csv
...
//app.use(express.static('data/mnist/'))
...
//app.post("/data/getannolist", (req,res) => {
//    console.log("Specific Data request recieved")
//    list = req.body.list
//    payload = []
//    list.forEach(idFromList => {
//        payload.push(getElemntByID(idFromList))
//    });
//    res.send(payload)
//})
