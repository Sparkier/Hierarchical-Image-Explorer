...
def main(args):
    ...
    features, ids = load_features(args.feature_json)
    print("Running t-sne")
    points_df = run_tsne(features, ids)
    out_name = args.feature_json.replace("_feat.json", "") + "_2d_points.csv"
    print("Saving results to file")
    save_points_data(args.output_dir, out_name, points_df)
    print("Done")
