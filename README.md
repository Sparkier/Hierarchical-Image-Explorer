...
- Run dimensionality reduction: `python data_processing.py data/example/raw_data.arrow data/example/ -enc arrow.activations -dim umap ` this generates the file `data/example/raw_data_umap.arrow`
